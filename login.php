...
<meta name="theme-color" content="#563d7c">
  ...
  <form action="login.php" class="form-signin" method="post" accept-charset="utf-8">
    <img class="mb-4" src="img/sign.png" alt="" width="100" height="72">
...
<!-- 
      <div class = "form-group">
        <input type="text" class="form-control" name="pass" placeholder="Password *" value="" required="" />
      </div> -->
       <div class="form-group">
